...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatNonZeroToZero() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "green", "violet", "notviolet");
        List<String> list2 = this.createFromArgsTest(0, "green", "violet", "notviolet");
        /*
         * Evaluate the correctness of the result
         */
        list1.retreat();
    ...
    @Test
    public final void testRetreatNonZeroToNonZeroOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "green", "violet", "notviolet");
        List<String> list2 = this.createFromArgsTest(1, "green", "violet", "notviolet");
        /*
         * Evaluate the correctness of the result
         */
        list1.retreat();
    ...
    @Test
    public final void testRetreatNonZeroToNonZeroTwo() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "green", "violet", "notviolet");
        List<String> list2 = this.createFromArgsTest(2, "green", "violet", "notviolet");
        /*
         * Evaluate the correctness of the result
         */
        list1.retreat();
